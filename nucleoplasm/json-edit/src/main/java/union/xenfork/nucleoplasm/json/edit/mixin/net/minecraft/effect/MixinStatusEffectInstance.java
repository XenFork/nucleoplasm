package union.xenfork.nucleoplasm.json.edit.mixin.net.minecraft.effect;
...
import union.xenfork.nucleoplasm.json.edit.face.net.minecraft.effect.GetStatusEffectInstance;
